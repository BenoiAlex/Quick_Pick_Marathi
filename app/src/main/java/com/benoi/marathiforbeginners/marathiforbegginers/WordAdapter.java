...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //find the textview in list_item with id marathi
        TextView marathiTextView = (TextView) listItemView.findViewById(R.id.marathi_text_view);
        //gets the marathi Translation and set it to the text of this textView
        marathiTextView.setText(word_item.getMarathiTranslation());
